...
public class SeanceController implements Initializable {
    ...
    @FXML private Spinner<Integer> spinnerNbTickets1;
    @FXML private Spinner<Integer> spinnerNbTickets2;
    @FXML private Spinner<Integer> spinnerNbTickets3;
...
//        System.out.println("event : " + event.toString());
    ...
    public void buyTickets(ActionEvent actionEvent) {
        ...
        try {
            if (nbTickets1 + nbTickets2 + nbTickets3 > SeanceService.getRemainingPlaces(seance)) {
                throw new RuntimeException("Le nombre de tickets est plus grand que le nombre de places disponibles.");
            }
            ...
            SeanceStatusCache.getInstance().invalidate(seanceId); // vider le cache des status des séances
